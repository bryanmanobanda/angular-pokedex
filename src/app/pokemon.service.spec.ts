...
describe('PokemonService', () => {
  ...
  it('should Pokemon Details with data', () => {
    ...
    let req = httpMock.expectOne(`${environment.poxedexBaseUrl}/pokemon/1`);
  ...
  it('should Pokemon List with data', () => {
    ...
    let req = httpMock.expectOne(`${environment.poxedexBaseUrl}/pokemon/`);
    expect(req.request.method).toBe('GET');
